...
export const DEFAULT_FESTIVAL_SCHEDULES: FestivalScheduleItem[] = [
  // 14 September 2026 (ಸೋಮವಾರ)
  {
    id: "fs-14-1",
    title: "ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿ ಪ್ರತಿಷ್ಠಾಪನ ಪೂಜೆ ಮತ್ತು ಮಹಾಮಂಗಳಾರತಿ",
    description: "ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿ ಪ್ರತಿಷ್ಠಾಪನ ಪೂಜೆ ಮತ್ತು ಮಹಾಮಂಗಳಾರತಿ.",
  ...
  },
  {
    ...
    description: "ಪ್ರಸಾದ ವಿನಿಯೋಗ, ದಾಸೋಹಿಗಳ ಪರವಾಗಿ ಸೇವಾ ಸಮಿತಿಯಿಂದ.",
    schedule_date: "2026-09-14",
    start_time: "12:30",
    end_time: "15:00",
    venue: "ಅನ್ನದಾಸೋಹ ಮಂಟಪ",
    category: "prasadam",
    is_published: true,
    sort_order: 2,
    created_at: new Date().toISOString(),
  },
  {
    ...
    description: "ಬಡಾವಣೆಗಳ ನಿವಾಸಿಗಳಿಗೆ ಮತ್ತು ಮಕ್ಕಳಿಗೆ ಕ್ರೀಡಾ ಚಟುವಟಿಕೆಗಳು.",
    schedule_date: "2026-09-14",
    start_time: "15:00",
    end_time: "18:30",
    venue: "ಬಡಾವಣೆಯ ಮೈದಾನ",
  ...
  },
  {
    ...
    description: "ಸಂಜೆಯ ಶ್ರೀ ಶಾಂತಿಮಹಾಗಣಪತಿ ಪೂಜೆ ಮತ್ತು ಮಹಾಮಂಗಳಾರತಿ.",
    schedule_date: "2026-09-14",
    start_time: "18:30",
    end_time: "19:00",
    venue: "ಮುಖ್ಯ ಮಂಟಪ",
  ...
  },
  {
    ...
    description: "2026-ನೇ ಸಾಲಿನಲ್ಲಿ ಎಸ್.ಎಸ್.ಎಲ್.ಸಿ ಮತ್ತು ದ್ವಿತೀಯ ಪಿಯುಸಿಯಲ್ಲಿ ಉನ್ನತ ಶ್ರೇಣಿಯಲ್ಲಿ ತೇರ್ಗಡೆಯಾದ ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ ಪ್ರತಿಭಾ ಪುರಸ್ಕಾರ ಕಾರ್ಯಕ್ರಮ ಹಾಗೂ ಬಡಾವಣೆಯ ನಿವಾಸಿಗಳಿಂದ ಸಾಂಸ್ಕೃತಿಕ ಮತ್ತು ಮನರಂಜನೆ ಕಾರ್ಯಕ್ರಮಗಳು.",
    schedule_date: "2026-09-14",
    start_time: "19:00",
    end_time: "20:00",
    venue: "ಸಾಂಸ್ಕೃತಿಕ ರಂಗಮಂಟಪ",
    category: "cultural",
    is_published: true,
    sort_order: 5,
    created_at: new Date().toISOString(),
  ...
  // 15 September 2026 (ಮಂಗಳವಾರ)
  {
    id: "fs-15-1",
    title: "ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿ ಪೂಜೆ ಮತ್ತು ಮಹಾಮಂಗಳಾರತಿ",
    description: "ಬೆಳಿಗ್ಗೆ ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿ ಪೂಜೆ ಮತ್ತು ಮಹಾಮಂಗಳಾರತಿ.",
  ...
  },
  {
    ...
    description: "ಸಾಮೂಹಿಕ ಅನ್ನಸಂತರ್ಪಣೆ, ಸಮಿತಿ ಪರವಾಗಿ ದಾಸೋಹಿಗಳಿಂದ.",
    schedule_date: "2026-09-15",
    start_time: "13:00",
    end_time: "16:00",
    venue: "ಅನ್ನದಾಸೋಹ ಮಂಟಪ",
  ...
  },
  {
    id: "fs-15-4",
    title: "ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿ ಪೂಜೆ ಮತ್ತು ಮಹಾಮಂಗಳಾರತಿ",
    description: "ಸಂಜೆಯ ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿ ಪೂಜೆ ಮತ್ತು ಮಹಾಮಂಗಳಾರತಿ.",
    schedule_date: "2026-09-15",
    start_time: "18:30",
    end_time: "19:00",
    venue: "ಮುಖ್ಯ ಮಂಟಪ",
  ...
  {
    id: "fs-15-5",
    title: "ಮಾಜಿ ಸೈನಿಕರಿಗೆ ಅಭಿನಂದನೆ & ಬಹುಮಾನ ವಿತರಣಾ ಸಮಾರಂಭ",
    description: "ಬಡಾವಣೆಗಳ ಮಾಜಿ ಸೈನಿಕರಿಗೆ ಅಭಿನಂದನಾ ಕಾರ್ಯಕ್ರಮ, ಪ್ರಸಾದ-ಅನ್ನಸಂತರ್ಪಣೆ ಹಾಗೂ ಪ್ರಾಯೋಜಕರಿಗೆ, ಹೂವಿನ ಹರಾಜು ದಾನಿಗಳಿಗೆ ನೆನಪಿನ ಕಾಣಿಕೆ ವಿತರಣೆ, ಸಾಂಸ್ಕೃತಿಕ ಇನ್ನಿತರೆ ಕ್ರೀಡೆಯಲ್ಲಿ ವಿಜೇತರಾದವರಿಗೆ ಬಹುಮಾನ ವಿತರಣೆ ಹಾಗೂ ನಿವಾಸಿಗಳಿಂದ ಸಾಂಸ್ಕೃತಿಕ ಮತ್ತು ಮನರಂಜನೆ ಕಾರ್ಯಕ್ರಮಗಳು.",
    schedule_date: "2026-09-15",
    start_time: "19:00",
    end_time: "20:00",
    venue: "ಸಾಂಸ್ಕೃತಿಕ ರಂಗಮಂಟಪ",
  ...
  {
    id: "fs-16-4",
    title: "ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿಯ ಹೂವಿನಹಾರ ಮತ್ತು ಇತರೆ ಹಾರಗಳ ಹರಾಜು",
    description: "ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿಯ ಹೂವಿನಹಾರ ಮತ್ತು ಇತರೆ ಹಾರಗಳ ಬಹಿರಂಗ ಹರಾಜು ಕಾರ್ಯಕ್ರಮ.",
    schedule_date: "2026-09-16",
    start_time: "14:00",
    end_time: "15:00",
    venue: "ಮುಖ್ಯ ಮಂಟಪ",
  ...
  {
    id: "fs-16-5",
    title: "ವಿಸರ್ಜನಾ ಮೆರವಣಿಗೆ ಪ್ರಾರಂಭ & ಚಂದ್ರವಳ್ಳಿಯಲ್ಲಿ ವಿಸರ್ಜನೆ",
    description: "ವಿವಿಧ ವಾದ್ಯ ತಂಡಗಳೊಂದಿಗೆ ಎಲ್ಲಾ ಬಡಾವಣೆಗಳ ನಿವಾಸಿಗಳ ಭಾಗವಹಿಸುವಿಕೆಯೊಂದಿಗೆ ಶ್ರೀ ಶಾಂತಿ ಮಹಾಗಣಪತಿಯ ವಿಜೃಂಭಣೆಯ ವಿಸರ್ಜನಾ ಮೆರವಣಿಗೆ ಪ್ರಾರಂಭ ಹಾಗೂ ಚಂದ್ರವಳ್ಳಿಯಲ್ಲಿ ವಿಸರ್ಜನೆ.",
    schedule_date: "2026-09-16",
    start_time: "15:00",
    end_time: "19:00",
    venue: "ಮೆರವಣಿಗೆ ಮಾರ್ಗದಿಂದ ಚಂದ್ರವಳ್ಳಿಕೆರೆ",
    category: "event",
    is_published: true,
    sort_order: 5,
    created_at: new Date().toISOString(),
  },
  {
    ...
    description: "ಮೆರವಣಿಗೆ ಅಂತ್ಯದಲ್ಲಿ ಪ್ರಸಾದ ವಿನಿಯೋಗ, ದಾಸೋಹಿಗಳ ಪರವಾಗಿ ಸೇವಾ ಸಮಿತಿಯಿಂದ.",
    schedule_date: "2026-09-16",
    start_time: "19:00",
    end_time: "21:00",
    venue: "ಚಂದ್ರವಳ್ಳಿಕೆರೆ / ವಿಸರ್ಜನಾ ಸ್ಥಳ",
    category: "prasadam",
    is_published: true,
    sort_order: 6,
    created_at: new Date().toISOString(),
